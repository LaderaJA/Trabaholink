...
const PAGES_TO_CACHE = [
    ...
    '/users/profile/',            // User profile (will match /users/profile/username)
];
...
/**
 * Get offline fallback page with back button
 */
    ...
    const offlineHTML = `
        ...
        <body>
            <div class="offline-container">
                ...
                <p>This page hasn't been saved for offline viewing yet. You need an internet connection to access it.</p>
                ...
                <div class="cached-note">
                    💡 <strong>Tip:</strong> Pages you visit while online are automatically saved. Try visiting the home page, jobs, or your profile when you have internet connection.
                </div>
            </div>
        </body>
        </html>
